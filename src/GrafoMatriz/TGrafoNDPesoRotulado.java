...
Classe: Classe relativa ao grafo não direcionado com peso nos vértices e arestas
...
public class TGrafoNDPesoRotulado extends Grafo {
    // Atributos Privados
    protected double[][] adj; // matriz de adjacência
    protected double[] pesos;

    // Métodos Públicos
    public TGrafoNDPesoRotulado(int n) { // construtor
        this.n = n;
    ...
    public TGrafoNDPesoRotulado(double[][] adj, double[] pesos) {
        this.adj = adj;
        this.n = adj.length;
        this.pesos = pesos;
        this.nomes = new String[n];
